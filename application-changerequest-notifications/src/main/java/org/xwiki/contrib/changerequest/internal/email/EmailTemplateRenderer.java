 ...
 * This is an improved copy of {@code org.xwiki.notifications.notifiers.internal.email.EmailTemplateRenderer}.
 * TODO: This should be removed once XWIKI-21856 is done and available in the parent version of this extension.
 *
 * @version $Id$
 * @since 1.14
 */
...
public class EmailTemplateRenderer
{
     ...
     * @param customBindings the specific bindings to use in the template
