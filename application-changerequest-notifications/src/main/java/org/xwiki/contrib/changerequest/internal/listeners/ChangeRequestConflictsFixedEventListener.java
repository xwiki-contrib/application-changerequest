...
/**
 * Listener of {@link ChangeRequestConflictsFixedEvent} to trigger {@link ChangeRequestRebasedRecordableEvent}.
 *
 * @version $Id$
 * @since 0.10
 */
@Component
@Singleton
@Named(ChangeRequestConflictsFixedEventListener.NAME)
public class ChangeRequestConflictsFixedEventListener extends AbstractChangeRequestEventListener
{
    static final String NAME = "ChangeRequestConflictsFixedEventListener";

    /**
     * Default constructor.
     */
    public ChangeRequestConflictsFixedEventListener()
    {
        super(NAME, Collections.singletonList(new ChangeRequestConflictsFixedEvent()));
    }
    ...
    public void processLocalEvent(Event event, Object source, Object data)
    {
        ...
        try {
            ...
            ChangeRequestRebasedRecordableEvent recordableEvent =
                new ChangeRequestRebasedRecordableEvent(changeRequestId, true, fileChange.getId());
