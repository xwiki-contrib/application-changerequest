...
/**
 * Default converter for {@link ApproversUpdatedTargetableEvent}.
 *
 * @version $Id$
 * @since 0.11
 */
@Component
@Singleton
@Named(ApproversUpdatedTargetableEvent.EVENT_NAME)
public class ApproversUpdatedRecordableEventConverter implements RecordableEventConverter
{
    @Inject
    ...
    {
        return Collections.singletonList(new ApproversUpdatedTargetableEvent(Collections.emptySet()));
    }
}
