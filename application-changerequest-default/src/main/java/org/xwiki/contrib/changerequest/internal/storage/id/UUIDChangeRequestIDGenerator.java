...
/**
 * Implementation of {@link ChangeRequestIDGenerator} that relies on a random UUID.
 *
 * @version $Id$
 * @since 0.1
 */
...
@Named("uuid")
@Singleton
public class UUIDChangeRequestIDGenerator implements ChangeRequestIDGenerator
{
    @Override
