...
/**
 * Default implementation of a message receiver for {@link ChangeRequestStatusChangedRecordableEvent}.
 *
 * @version $Id$
 * @since 0.16
 */
...
@Singleton
public class StatusUpdatedEventReceiver extends AbstractChangeRequestReceiver
{
    @Override
    public void receiveWithUserSet(ReplicationReceiverMessage message) throws ReplicationException
    {
        ...
        ChangeRequestStatus oldStatus = ChangeRequestStatus.valueOf(this.messageReader.getMetadata(message,
            StatusUpdatedReplicationSenderMessage.OLD_STATUS, true));
        ChangeRequestStatus newStatus = ChangeRequestStatus.valueOf(this.messageReader.getMetadata(message,
            StatusUpdatedReplicationSenderMessage.NEW_STATUS, true));
        ChangeRequestStatusChangedRecordableEvent event =
            new ChangeRequestStatusChangedRecordableEvent(changeRequestId, oldStatus, newStatus);
