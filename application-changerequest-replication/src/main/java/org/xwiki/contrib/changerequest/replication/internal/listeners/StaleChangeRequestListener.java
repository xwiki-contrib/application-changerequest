...
public class StaleChangeRequestListener extends AbstractChangeRequestEventListener<StaleChangeRequestRecordableEvent>
{
    ...
    static final String NAME =
        "org.xwiki.contrib.changerequest.replication.internal.listeners.StaleChangeRequestListener";

    /**
     * Default constructor.
     */
    public StaleChangeRequestListener()
    {
        super(NAME, new StaleChangeRequestRecordableEvent());
    }
