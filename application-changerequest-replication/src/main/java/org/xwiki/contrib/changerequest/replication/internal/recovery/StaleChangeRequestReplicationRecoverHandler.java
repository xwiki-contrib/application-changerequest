...
/**
 * Default component for recovery of replicated events related to change request stale.
 *
 * @version $Id$
 * @since 1.4
 */
...
@Singleton
public class StaleChangeRequestReplicationRecoverHandler extends AbstractChangeRequestReplicationRecoverHandler
{
    @Override
