...
/**
 * Default implementation of a message receiver for {@link StaleChangeRequestRecordableEvent}.
 *
 * @version $Id$
 * @since 0.16
 */
...
public class StaleChangeRequestEventReceiver extends AbstractChangeRequestReceiver
{
    @Override
    protected void receiveWithUserSet(ReplicationReceiverMessage message) throws ReplicationException
    {
        ...
        StaleChangeRequestRecordableEvent event = new StaleChangeRequestRecordableEvent(changeRequestId);
