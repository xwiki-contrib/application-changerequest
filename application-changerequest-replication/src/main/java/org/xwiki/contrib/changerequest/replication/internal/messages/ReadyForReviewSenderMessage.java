...
/**
 * Default sender message implementation for {@link ChangeRequestReadyForReviewTargetableEvent}.
 *
 * @version $Id$
 * @since 0.16
 */
    ...
    AbstractChangeRequestEventReplicationSenderMessage<ChangeRequestReadyForReviewTargetableEvent>
{
     ...
     * Default constructor.
     */
    public ReadyForReviewSenderMessage()
    {
        super(ChangeRequestReadyForReviewTargetableEvent.EVENT_NAME);
    }
