...
public class ReviewAddedListener extends AbstractChangeRequestEventListener<ChangeRequestReviewAddedRecordableEvent>
{
    ...
    static final String NAME =
        "org.xwiki.contrib.changerequest.replication.internal.listeners.ReviewAddedListener";

    /**
     * Default constructor.
     */
    public ReviewAddedListener()
    {
        super(NAME, new ChangeRequestReviewAddedRecordableEvent());
    }
