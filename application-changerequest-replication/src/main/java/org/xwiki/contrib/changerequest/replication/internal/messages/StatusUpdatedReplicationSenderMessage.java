...
@Component(roles = StatusUpdatedReplicationSenderMessage.class)
public class StatusUpdatedReplicationSenderMessage extends AbstractChangeRequestEventReplicationSenderMessage
{
    ...
    public void initialize(ChangeRequestStatusChangedRecordableEvent event)
    {
