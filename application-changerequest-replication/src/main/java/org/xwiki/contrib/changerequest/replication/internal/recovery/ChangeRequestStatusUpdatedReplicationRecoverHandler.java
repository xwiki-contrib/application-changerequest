...
/**
 * Default component for recovery of replicated events related to change request status change.
 *
 * @version $Id$
 * @since 1.4
 */
...
@Singleton
public class ChangeRequestStatusUpdatedReplicationRecoverHandler extends AbstractChangeRequestReplicationRecoverHandler
{
    @Override
