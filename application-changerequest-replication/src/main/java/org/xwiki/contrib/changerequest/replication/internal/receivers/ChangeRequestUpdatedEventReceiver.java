...
/**
 * Default implementation of a message receiver for {@link ChangeRequestUpdatedRecordableEvent}.
 *
 * @version $Id$
 * @since 0.16
 */
...
public class ChangeRequestUpdatedEventReceiver extends AbstractChangeRequestReceiver
{
    @Override
    protected void receiveWithUserSet(ReplicationReceiverMessage message) throws ReplicationException
    {
        ...
        ChangeRequestUpdatedRecordableEvent event = new ChangeRequestUpdatedRecordableEvent(changeRequestId);
