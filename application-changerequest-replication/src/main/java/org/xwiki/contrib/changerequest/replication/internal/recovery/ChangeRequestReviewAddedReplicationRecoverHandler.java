...
/**
 * Default component for recovery of replicated events related to change request review.
 *
 * @version $Id$
 * @since 1.4
 */
...
@Singleton
public class ChangeRequestReviewAddedReplicationRecoverHandler extends AbstractChangeRequestReplicationRecoverHandler
{
    @Override
