    ...
    AbstractChangeRequestEventListener<ChangeRequestReadyForReviewTargetableEvent, ReadyForReviewSenderMessage>
{
    ...
    static final String NAME =
        "org.xwiki.contrib.changerequest.replication.internal.listeners.ReadyForReviewListener";

    /**
     * Default constructor.
     */
    public ReadyForReviewListener()
    {
        super(NAME, new ChangeRequestReadyForReviewTargetableEvent());
    }
