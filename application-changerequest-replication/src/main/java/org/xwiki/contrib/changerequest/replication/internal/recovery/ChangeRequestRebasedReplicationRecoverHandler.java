...
/**
 * Default component for recovery of replicated events related to change request rebase.
 *
 * @version $Id$
 * @since 1.4
 */
...
@Singleton
public class ChangeRequestRebasedReplicationRecoverHandler extends AbstractChangeRequestReplicationRecoverHandler
{
    @Override
