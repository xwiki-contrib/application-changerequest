...
/**
 * Default component for recovery of replicated events related to change request filechange added.
 *
 * @version $Id$
 * @since 1.4
 */
...
@Singleton
public class ChangeRequestFileChangeAddedReplicationRecoverHandler
