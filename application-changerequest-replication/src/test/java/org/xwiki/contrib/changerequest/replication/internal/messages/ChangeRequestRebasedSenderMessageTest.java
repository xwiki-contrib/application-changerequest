...
/**
 * Tests for {@link ChangeRequestRebasedSenderMessage}
 *
 * @version $Id$
 */
@ComponentTest
class ChangeRequestRebasedSenderMessageTest
{
    private static final String CONTEXT_USER = "XWiki.ContextUser";

    @InjectMockComponents
    private ChangeRequestRebasedSenderMessage senderMessage;
    ...
    void initialize()
    {
        ...
        String fileChangeId = "filechange24";
        ChangeRequestRebasedRecordableEvent event =
            new ChangeRequestRebasedRecordableEvent(crId, false, fileChangeId);
        ...
        parameters.put("FILECHANGE_ID", Collections.singleton(fileChangeId));
        parameters.put("IS_CONFLICT_FIXING", Collections.singleton("false"));
    ...
    void getType()
    {
        assertEquals(ChangeRequestRebasedRecordableEvent.EVENT_NAME, senderMessage.getType());
    }
}