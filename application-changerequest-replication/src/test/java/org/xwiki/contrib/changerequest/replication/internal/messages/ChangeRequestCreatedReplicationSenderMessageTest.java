...
/**
 * Tests for {@link ChangeRequestCreatedReplicationSenderMessage}
 *
 * @version $Id$
 */
@ComponentTest
class ChangeRequestCreatedReplicationSenderMessageTest
{
    private static final String CONTEXT_USER = "XWiki.ContextUser";

    @InjectMockComponents
    private ChangeRequestCreatedReplicationSenderMessage senderMessage;
    ...
    void initialize()
    {
        ...
        when(this.converter.convert(String.class, true)).thenReturn("true");
    ...
    void getType()
    {
        assertEquals(ChangeRequestCreatedRecordableEvent.EVENT_NAME, senderMessage.getType());
    }
}