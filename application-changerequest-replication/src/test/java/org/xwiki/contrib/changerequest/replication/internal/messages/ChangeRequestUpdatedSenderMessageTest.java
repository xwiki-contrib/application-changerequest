...
/**
 * Tests for {@link ChangeRequestUpdatedSenderMessage}
 *
 * @version $Id$
 */
@ComponentTest
class ChangeRequestUpdatedSenderMessageTest
{
    private static final String CONTEXT_USER = "XWiki.ContextUser";

    @InjectMockComponents
    private ChangeRequestUpdatedSenderMessage senderMessage;
    ...
    void getType()
    {
        assertEquals(ChangeRequestUpdatedRecordableEvent.EVENT_NAME, senderMessage.getType());
    }
}