...
/**
 * Tests for {@link ChangeRequestRebasedListener}.
 *
 * @version $Id$
 */
@ComponentTest
class ChangeRequestRebasedListenerTest
{
    @InjectMockComponents
    private ChangeRequestRebasedListener listener;
    ...
    void getEvents()
    {
        ...
        assertTrue(listener.getEvents().get(0) instanceof ChangeRequestRebasedRecordableEvent);
    }
    ...
    void onEvent(MockitoComponentManager componentManager) throws Exception
    {
        ...
        ChangeRequestRebasedRecordableEvent event = new ChangeRequestRebasedRecordableEvent(crId, false, "");
        ...
        String expectedHint = ChangeRequestRebasedRecordableEvent.EVENT_NAME;
