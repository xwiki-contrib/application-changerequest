...
/**
 * Tests for {@link FileChangeAddedReplicationSenderMessage}
 *
 * @version $Id$
 */
@ComponentTest
class FileChangeAddedReplicationSenderMessageTest
{
    private static final String CONTEXT_USER = "XWiki.ContextUser";

    @InjectMockComponents
    private FileChangeAddedReplicationSenderMessage senderMessage;
    ...
    void initialize()
    {
        ...
        String fileChangeId = "someFile";
        ChangeRequestFileChangeAddedRecordableEvent event =
            new ChangeRequestFileChangeAddedRecordableEvent(crId, fileChangeId);
    ...
    void getType()
    {
        assertEquals(ChangeRequestFileChangeAddedRecordableEvent.EVENT_NAME, senderMessage.getType());
    }
}