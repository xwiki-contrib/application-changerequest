...
/**
 * Tests for {@link StatusUpdatedReplicationSenderMessage}
 *
 * @version $Id$
 */
@ComponentTest
class StatusUpdatedReplicationSenderMessageTest
{
    private static final String CONTEXT_USER = "XWiki.ContextUser";

    @InjectMockComponents
    private StatusUpdatedReplicationSenderMessage senderMessage;
    ...
    void initialize()
    {
        ...
        ChangeRequestStatusChangedRecordableEvent event = new ChangeRequestStatusChangedRecordableEvent(crId,
            ChangeRequestStatus.DRAFT, ChangeRequestStatus.READY_FOR_MERGING);
        ...
        parameters.put("OLD_STATUS", Collections.singleton("DRAFT"));
        parameters.put("NEW_STATUS", Collections.singleton("READY_FOR_MERGING"));
    ...
    void getType()
    {
        assertEquals(ChangeRequestStatusChangedRecordableEvent.EVENT_NAME, senderMessage.getType());
    }
}