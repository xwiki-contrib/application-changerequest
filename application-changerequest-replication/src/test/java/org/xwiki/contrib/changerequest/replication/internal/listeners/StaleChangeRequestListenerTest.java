...
/**
 * Tests for {@link StaleChangeRequestListener}.
 *
 * @version $Id$
 */
@ComponentTest
class StaleChangeRequestListenerTest
{
    @InjectMockComponents
    private StaleChangeRequestListener listener;
    ...
    void getEvents()
    {
        ...
        assertTrue(listener.getEvents().get(0) instanceof StaleChangeRequestRecordableEvent);
    }
    ...
    void onEvent(MockitoComponentManager componentManager) throws Exception
    {
        ...
        StaleChangeRequestRecordableEvent event = new StaleChangeRequestRecordableEvent(crId);
        ...
        String expectedHint = StaleChangeRequestRecordableEvent.EVENT_NAME;
