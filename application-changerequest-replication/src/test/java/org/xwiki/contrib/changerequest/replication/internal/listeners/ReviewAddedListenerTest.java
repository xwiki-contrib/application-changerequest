...
/**
 * Tests for {@link ReviewAddedListener}.
 *
 * @version $Id$
 */
@ComponentList({
...
@ComponentTest
class ReviewAddedListenerTest
{
    @InjectMockComponents
    private ReviewAddedListener listener;
    ...
    void getEvents()
    {
        ...
        assertTrue(listener.getEvents().get(0) instanceof ChangeRequestReviewAddedRecordableEvent);
    }
    ...
    void onEvent(MockitoComponentManager componentManager) throws Exception
    {
        ...
        ChangeRequestReviewAddedRecordableEvent event = new ChangeRequestReviewAddedRecordableEvent(crId, "");
        ...
        String expectedHint = ChangeRequestReviewAddedRecordableEvent.EVENT_NAME;
