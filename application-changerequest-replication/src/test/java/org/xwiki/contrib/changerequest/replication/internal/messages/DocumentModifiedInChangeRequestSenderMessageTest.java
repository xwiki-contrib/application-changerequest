...
/**
 * Tests for {@link DocumentModifiedInChangeRequestSenderMessage}
 *
 * @version $Id$
 */
@ComponentTest
class DocumentModifiedInChangeRequestSenderMessageTest
{
    private static final String CONTEXT_USER = "XWiki.ContextUser";

    @InjectMockComponents
    private DocumentModifiedInChangeRequestSenderMessage senderMessage;
    ...
    void getType()
    {
        assertEquals(DocumentModifiedInChangeRequestEvent.EVENT_NAME, senderMessage.getType());
    }
}