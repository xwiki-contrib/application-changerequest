...
/**
 * Tests for {@link StatusUpdatedListener}.
 *
 * @version $Id$
 */
@ComponentTest
class StatusUpdatedListenerTest
{
    @InjectMockComponents
    private StatusUpdatedListener listener;
    ...
    void getEvents()
    {
        ...
        assertTrue(listener.getEvents().get(0) instanceof ChangeRequestStatusChangedRecordableEvent);
    }
    ...
    void onEvent(MockitoComponentManager componentManager) throws Exception
    {
        ...
        ChangeRequestStatusChangedRecordableEvent event = new ChangeRequestStatusChangedRecordableEvent(crId, null, null);
        ...
        String expectedHint = ChangeRequestStatusChangedRecordableEvent.EVENT_NAME;
