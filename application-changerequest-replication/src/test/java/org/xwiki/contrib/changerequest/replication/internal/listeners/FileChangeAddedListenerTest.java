...
/**
 * Tests for {@link FileChangeAddedListener}.
 *
 * @version $Id$
 */
@ComponentTest
class FileChangeAddedListenerTest
{
    @InjectMockComponents
    private FileChangeAddedListener listener;
    ...
    void getEvents()
    {
        ...
        assertTrue(listener.getEvents().get(0) instanceof ChangeRequestFileChangeAddedRecordableEvent);
    }
    ...
    void onEvent(MockitoComponentManager componentManager) throws Exception
    {
        ...
        ChangeRequestFileChangeAddedRecordableEvent event = new ChangeRequestFileChangeAddedRecordableEvent(crId, "");
        ...
        String expectedHint = ChangeRequestFileChangeAddedRecordableEvent.EVENT_NAME;
