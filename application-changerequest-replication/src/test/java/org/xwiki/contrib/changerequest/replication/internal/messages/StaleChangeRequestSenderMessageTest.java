...
/**
 * Tests for {@link StaleChangeRequestSenderMessage}
 *
 * @version $Id$
 */
@ComponentTest
class StaleChangeRequestSenderMessageTest
{
    private static final String CONTEXT_USER = "XWiki.ContextUser";

    @InjectMockComponents
    private StaleChangeRequestSenderMessage senderMessage;
    ...
    void getType()
    {
        assertEquals(StaleChangeRequestRecordableEvent.EVENT_NAME, senderMessage.getType());
    }
}