...
/**
 * Tests for {@link ChangeRequestDiscussionListener}.
 *
 * @version $Id$
 */
@ComponentTest
class ChangeRequestDiscussionListenerTest
{
    @InjectMockComponents
    private ChangeRequestDiscussionListener listener;
    ...
    void getEvents()
    {
        ...
        assertTrue(listener.getEvents().get(0) instanceof ChangeRequestDiscussionRecordableEvent);
    }
    ...
    void onEvent(MockitoComponentManager componentManager) throws Exception
    {
        ...
        ChangeRequestDiscussionRecordableEvent event = new ChangeRequestDiscussionRecordableEvent(crId, "", "", "");
        ...
        String expectedHint = ChangeRequestDiscussionRecordableEvent.EVENT_NAME;
