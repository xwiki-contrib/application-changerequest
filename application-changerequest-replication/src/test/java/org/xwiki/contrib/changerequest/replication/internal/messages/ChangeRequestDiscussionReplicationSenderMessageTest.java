...
/**
 * Tests for {@link ChangeRequestDiscussionReplicationSenderMessage}
 *
 * @version $Id$
 */
@ComponentTest
class ChangeRequestDiscussionReplicationSenderMessageTest
{
    private static final String CONTEXT_USER = "XWiki.ContextUser";

    @InjectMockComponents
    private ChangeRequestDiscussionReplicationSenderMessage senderMessage;
    ...
    void initialize()
    {
        ...
        String discussionRef = "discussionRef";
        String discussionType = "discussionType";
        String messageReference = "messageRef";
        ChangeRequestDiscussionRecordableEvent event =
            new ChangeRequestDiscussionRecordableEvent(crId, discussionType, discussionRef, messageReference);
        ...
        parameters.put("DISCUSSION_REFERENCE", Collections.singleton(discussionRef));
        parameters.put("DISCUSSION_TYPE", Collections.singleton(discussionType));
        parameters.put("MESSAGE_REFERENCE", Collections.singleton(messageReference));
    ...
    void getType()
    {
        assertEquals(ChangeRequestDiscussionRecordableEvent.EVENT_NAME, senderMessage.getType());
    }
}