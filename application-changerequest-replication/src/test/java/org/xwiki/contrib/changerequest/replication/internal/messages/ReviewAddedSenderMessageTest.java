...
/**
 * Tests for {@link ReviewAddedSenderMessage}
 *
 * @version $Id$
 */
@ComponentTest
class ReviewAddedSenderMessageTest
{
    private static final String CONTEXT_USER = "XWiki.ContextUser";

    @InjectMockComponents
    private ReviewAddedSenderMessage senderMessage;
    ...
    void initialize()
    {
        ...
        String reviewId = "review43";
        String originalApprover = "me";
        ChangeRequestReviewAddedRecordableEvent event =
            new ChangeRequestReviewAddedRecordableEvent(crId, reviewId, originalApprover);
        ...
        parameters.put("REVIEW_ID", Collections.singleton(reviewId));
        parameters.put("ORIGINAL_APPROVER", Collections.singleton(originalApprover));
    ...
    void getType()
    {
        assertEquals(ChangeRequestReviewAddedRecordableEvent.EVENT_NAME, senderMessage.getType());
    }
}