...
/**
 * Event triggered when a new message is created in a change request.
 ...
 */
@Unstable
public class ChangeRequestDiscussionEvent implements Event
{
    /**
     * Default constructor.
     */
    public ChangeRequestDiscussionEvent()
    {
    }
    ...
    {
        return otherEvent instanceof ChangeRequestDiscussionEvent;
    }
}
